...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //First we order the Last name then we took them and descend by years of experience

            // This is another example is ::: repeating descending ThenBy it does the same thing as before order or descend
